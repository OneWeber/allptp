...
export default class CustomTabBar extends Component {
    ...
    _renderTab(name, page, isTabActive, onPressHandler) {
        ...
        const fontSize= this.props.isLarge?isTabActive ? 18 : 16 : this.props.isWishLarge?isTabActive ? 16 : 14 :null;
            ...
            <View style={[styles.tabs, {backgroundColor: this.props.backgroundColor,height:this.props.isWish?50:40}, this.props.style]}>
                {
                    this.props.isWish
                        ?
                        <View style={{height:50,justifyContent:'flex-start',alignItems: "center",width:40,flexDirection: "row"}}>
                            <AntDesign
                                name="left"
                                size={18}
                                style={{color:"#333333",marginLeft:widthScreen*0.04}}
                                onPress={()=>this.props.toGoBack()}
                            />
                        </View>
                ...
                </View>
                {
                    this.props.isWish
                        ?
                        <View style={{height:50,justifyContent:'flex-end',alignItems: "center",width:40,flexDirection: "row"}}>
                            <AntDesign
                                name="left"
                                size={18}
                                style={{color:"#ffffff",marginRight:widthScreen*0.04}}
                            />
                        </View>
