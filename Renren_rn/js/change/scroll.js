...
const ScrollableTabBar = createReactClass({
    ...
    renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
        ...
        const viewBackgroundColor = isTabActive ? this.props.buttonTheme : '#F5F7FA';
        return <Button
            key={`${name}_${page}`}
            accessible={true}
    ...
    render() {
        ...
        >
            ...
            >
                <View
                    style={[styles.tabs, {width: this.state._containerWidth, justifyContent:'flex-start'}, this.props.tabsContainerStyle, ]}
                    ref={'tabContainer'}
